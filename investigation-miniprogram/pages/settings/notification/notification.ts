...
Page({
  ...
  onTaskReminderChange(e: WechatMiniprogram.CustomEvent) {
  ...
  onPomodoroStartChange(e: WechatMiniprogram.CustomEvent) {
    this.saveSetting('pomodoroStartReminder', e.detail.value)
  },

  onPomodoroCompleteChange(e: WechatMiniprogram.CustomEvent) {
    this.saveSetting('pomodoroCompleteReminder', e.detail.value)
  },

  onBreakReminderChange(e: WechatMiniprogram.CustomEvent) {
    this.saveSetting('breakReminder', e.detail.value)
  },

  onHabitReminderChange(e: WechatMiniprogram.CustomEvent) {
