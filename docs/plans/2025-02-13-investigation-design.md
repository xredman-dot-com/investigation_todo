...
### 核心理念体现
虽然第一版不直接推出回顾功能，但交互设计上要埋下"格物"的种子：
...
cos_url: string             # 腾讯云COS地址
cos_key: string             # COS对象键
...
### 竞品分析来源
- [滴答清单功能特性](https://ticktick.com/features?language=zh_cn)
- [滴答清单习惯打卡功能](https://help.dida365.com/articles/6950408300395495424)
- [滴答清单专注数据统计](https://help.dida365.com/articles/6950408300395495424)
- [Microsoft To Do My Day](https://support.microsoft.com/en-us/microsoft-to-do)
- [OmniFocus GTD Review](https://support.omnigroup.com)
- [Things 3 vs OmniFocus](https://techradar.com/best-apps/best-to-do-list-apps)
- [Habitica Gamification](https://habitica.com)
- [Best Recurring Task Apps](https://www.amplenote.com/blog/five_best_todo_list_apps_for-recurring-tasks)
- [滴答清单小组件](https://www.douyin.com/search/滴答清单小组件)
